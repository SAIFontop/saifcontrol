          ...
          <div className="overflow-y-auto max-h-[60vh]">
            {menu.items.map((item) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 border-b border-aw-border/50 transition-colors ${
                  item.disabled ? 'opacity-40 cursor-not-allowed' : 'hover:bg-white/5 cursor-pointer'
                }`}
              >
